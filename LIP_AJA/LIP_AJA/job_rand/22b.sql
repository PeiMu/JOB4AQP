...
/*+
NestLoop(k mk t kt mi_idx it2 mc cn ct mi it1)
NestLoop(k mk t kt mi_idx it2 mc cn ct mi)
NestLoop(k mk t kt mi_idx it2 mc cn ct)
NestLoop(k mk t kt mi_idx it2 mc cn)
NestLoop(k mk t kt mi_idx it2 mc)
