...
/*+
NestLoop(k mk mi_idx it2 cc cct1 cct2 ci chn t kt)
NestLoop(k mk mi_idx it2 cc cct1 cct2 ci chn t)
NestLoop(k mk mi_idx it2 cc cct1 cct2 ci chn)
...
NestLoop(k mk)
Leading(((((((((it2 ((k mk) mi_idx)) cc) cct1) cct2) ci) chn) t) kt))
*/
