...
/*+
NestLoop(at cn mc ct t mi it1 mk k)
NestLoop(at cn mc ct t mi it1 mk)
NestLoop(at cn mc ct t mi it1)
NestLoop(at cn mc ct t mi)
NestLoop(at cn mc ct t)
NestLoop(at cn mc ct)
HashJoin(at cn mc)
NestLoop(cn mc)
SeqScan(at)
SeqScan(cn)
...
IndexScan(mk)
IndexScan(k)
Leading((((((((at (cn mc)) ct) t) mi) it1) mk) k))*/
