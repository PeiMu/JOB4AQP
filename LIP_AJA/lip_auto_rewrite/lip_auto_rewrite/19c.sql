...
/*+
NestLoop(t rt ci n mi it mc cn chn an)
NestLoop(t rt ci n mi it mc cn chn)
NestLoop(t rt ci n mi it mc cn)
NestLoop(t rt ci n mi it mc)
NestLoop(t rt ci n mi it)
NestLoop(t rt ci n mi)
NestLoop(t rt ci n)
HashJoin(t rt ci)
NestLoop(rt ci)
SeqScan(t)
...
IndexScan(chn)
IndexScan(an)
Leading(((((((((t (rt ci)) n) mi) it) mc) cn) chn) an))*/
