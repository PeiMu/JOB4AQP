...
/*+
NestLoop(kt cc cct1 cct2 mi_idx it2 t ci chn mk k n)
NestLoop(kt cc cct1 cct2 mi_idx it2 t ci chn mk k)
NestLoop(kt cc cct1 cct2 mi_idx it2 t ci chn mk)
NestLoop(kt cc cct1 cct2 mi_idx it2 t ci chn)
NestLoop(kt cc cct1 cct2 mi_idx it2 t ci)
NestLoop(kt cc cct1 cct2 mi_idx it2 t)
NestLoop(cc cct1 cct2 mi_idx it2 t)
HashJoin(cc cct1 cct2 mi_idx it2)
...
IndexScan(k)
IndexScan(n)
Leading(((((((kt (((((cc cct1) cct2) mi_idx) it2) t)) ci) chn) mk) k) n))*/
