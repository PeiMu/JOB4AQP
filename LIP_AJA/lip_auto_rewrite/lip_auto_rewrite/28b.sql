...
SELECT sum(pg_lip_bloom_add(8, mi.movie_id)) FROM movie_info AS mi WHERE mi.info IN ('Sweden', 'Germany', 'Swedish', 'German');
SELECT sum(pg_lip_bloom_add(9, mi_idx.movie_id)) FROM movie_info_idx AS mi_idx WHERE mi_idx.info > '6.5';
