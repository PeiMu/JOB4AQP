...
SELECT sum(pg_lip_bloom_add(8, t.id)) FROM title AS t WHERE t.production_year > 2008;

/*+
NestLoop(it2 k mk t kt mi_idx mc cn ct mi it1)
NestLoop(it2 k mk t kt mi_idx mc cn ct mi)
NestLoop(it2 k mk t kt mi_idx mc cn ct)
NestLoop(it2 k mk t kt mi_idx mc cn)
NestLoop(it2 k mk t kt mi_idx mc)
