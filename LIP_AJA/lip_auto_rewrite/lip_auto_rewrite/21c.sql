...
SELECT sum(pg_lip_bloom_add(5, mi.movie_id)) FROM movie_info AS mi WHERE mi.info IN ('Sweden', 'Norway', 'Germany', 'Denmark', 'Swedish', 'Denish', 'Norwegian', 'German', 'English');
SELECT sum(pg_lip_bloom_add(6, t.id)) FROM title AS t WHERE t.production_year between 1950 and 2010;
