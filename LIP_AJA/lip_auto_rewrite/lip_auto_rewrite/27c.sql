...
SELECT sum(pg_lip_bloom_add(7, mi.movie_id)) FROM movie_info AS mi WHERE mi.info IN ('Sweden', 'Norway', 'Germany', 'Denmark', 'Swedish', 'Denish', 'Norwegian', 'German', 'English');
SELECT sum(pg_lip_bloom_add(8, t.id)) FROM title AS t WHERE t.production_year between 1950 and 2010;

/*+
NestLoop(cc cct1 cct2 mc ct cn mk ml lt k mi t)
NestLoop(cc cct1 cct2 mc ct cn mk ml lt k mi)
NestLoop(cc cct1 cct2 mc ct cn mk ml lt k)
MergeJoin(cc cct1 cct2 mc ct cn mk ml lt)
NestLoop(cc cct1 cct2 mc ct cn mk)
NestLoop(cc cct1 cct2 mc ct cn)
NestLoop(cc cct1 cct2 mc ct)
NestLoop(cc cct1 cct2 mc)
